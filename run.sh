...
uefi-run -b OVMF-pure-efi.fd -d -f src/font.psf -f src/wallpaper.bmp -f src/programs/test.bmp:programs/test/test.bmp -f bin/programs/test.bin:programs/test/test.bin bin/main.efi -- -enable-kvm -m 16G -cpu host -monitor stdio
echo