...
uefi-run -b OVMF-pure-efi.fd -d -f src/wallpaper.bmp -f src/fonts/font.psf:fonts/font.psf -f src/programs/test.bmp:programs/test/test.bmp -f bin/programs/test.bin:programs/test/test.bin bin/main.efi -- -enable-kvm -m 16G -cpu host -monitor stdio
echo