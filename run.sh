...
uefi-run -b OVMF-pure-efi.fd -d -f bin/system/smp.bin:system/smp.bin -f src/wallpapers/wallpaper.bmp:wallpapers/wallpaper.bmp -f src/fonts/font.psf:fonts/font.psf -f src/programs/rendering/program.bmp:programs/rendering/program.bmp -f bin/programs/rendering/program.bin:programs/rendering/program.bin -f src/programs/rendering/wall.bmp:programs/rendering/wall.bmp bin/main.efi -- -accel kvm -m 16G -cpu host -smp 4 -device e1000e,netdev=net -netdev user,id=net -monitor stdio
echo