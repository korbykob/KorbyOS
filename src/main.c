...
void start()
{
    while (!started)
    {
        ...
        drawRectangle(GOP->Mode->Info->HorizontalResolution / 2 - 160, GOP->Mode->Info->VerticalResolution / 2 - 40, 320, 48, white);
        drawString(L"Welcome to KorbyOS!", GOP->Mode->Info->HorizontalResolution / 2 - 152, GOP->Mode->Info->VerticalResolution / 2 - 32, black);
        drawButton(GOP->Mode->Info->HorizontalResolution / 2 - 48, GOP->Mode->Info->VerticalResolution / 2 + 24, 96, 48, white, &startButtonClick);
